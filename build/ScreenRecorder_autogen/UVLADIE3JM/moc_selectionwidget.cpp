...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SelectionWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_SelectionWidget_t qt_meta_stringdata_SelectionWidget = {
    {
        QT_MOC_LITERAL(0, 15),  // "SelectionWidget"
        QT_MOC_LITERAL(16, 12),  // "areaSelected"
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 4)   // "rect"
    },
    "SelectionWidget",
    "areaSelected",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_SelectionWidget[] = {
...
Q_CONSTINIT const QMetaObject SelectionWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_SelectionWidget.offsetsAndSizes,
    qt_meta_data_SelectionWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SelectionWidget_t,
        // Q_OBJECT / Q_GADGET
...
void SelectionWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SelectionWidget::*)(const QRect & );
            if (_t _q_method = &SelectionWidget::areaSelected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SelectionWidget::areaSelected(const QRect & _t1)
{
